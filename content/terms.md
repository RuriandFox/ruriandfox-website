...
2. **本アプリはGoogle（Firebase）等のクラウドサービスを利用しており、データは日本国内外のGoogleデータセンターに保存される場合があります。Google社とはデータ処理契約（DPA）を締結し、十分な安全管理措置を講じています。**
3. バックアップはFirebaseの公式バックアップ機能により毎日自動的に作成され、最大30日間Google Cloud Storageに保持されます。  
